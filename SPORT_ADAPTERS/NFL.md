...
|---|---|---:|---|---|---|---|---|---|
| [NFL schedule](https://www.nfl.com/schedules/) and [official flexible-scheduling procedures](https://www.nfl.com/legal/flexible-scheduling-procedures) | event identity, scheduled kickoff, flex/TBD changes, and season phase | 1 | manual/on-demand reference unless express permission or a licensed feed exists | league-wide event facts | retain official effective/publication time and local UTC retrieval | NFL.com Terms reviewed 2026-07-12; systematic retrieval restricted absent prior written consent | manual operational verification and material-event evidence only | conditional manual reference; no automated retrieval |
| [NFL Football Operations important dates](https://operations.nfl.com/calendar-events/nfl-important-dates) and current personnel injury-report policy | season-specific practice-report and game-status-report filing windows | 1 | manual/on-demand reference unless licensed | league policy | retain season/policy version, deadline timezone, publication/effective time, and local UTC retrieval | NFL source terms reviewed 2026-07-12; reverify exact policy and deadlines every season | manual official-report deadline and submission-state verification | conditional manual reference; no automated retrieval |
| [NFL inactives](https://www.nfl.com/inactives/) | official game-day inactive list | 1 | manual/on-demand reference unless licensed | named event/team | retain list publication time and local UTC retrieval | NFL.com Terms reviewed 2026-07-12; systematic retrieval restricted absent consent | manual inactive-state verification and price invalidation | conditional manual reference; no automated retrieval |
| [NFL Football Operations rulebook](https://operations.nfl.com/rules-officiating/2025-nfl-rulebook) | season-specific overtime/tie competition rules | 1 | manual/on-demand reference | competition rule by season phase | retain rulebook season/version and local UTC retrieval | reviewed 2026-07-12; reverify for the applicable season | settlement-identity evidence only; sportsbook rules still required | conditional manual reference |
| official NFL club report or announcement | injury status, starting quarterback, roster, venue, roof, relocation, or operational change | 1-2 | manual/on-demand public reference unless exact source permission allows automation | named club/event | publication/effective time and local UTC retrieval required | club/platform terms must be reviewed for the exact source | material operational fact and price invalidation | conditional; cannot clear a gate with unresolved permission or identity |
| licensed/documented sports-data provider | schedule, event status, injury report, availability, quarterback, inactive, roster, or venue facts | 2 | documented API/feed | contract-defined | provider update and local UTC timestamps retained | exact contract and permitted use must be reviewed; no provider is approved generically | operational facts within the reviewed license | provider-specific validation required |
| [National Weather Service API](https://www.weather.gov/documentation/services-web-api) or reviewed authoritative local source | venue-matched observations, forecasts, alerts, and operational weather risk | 1 for U.S. public weather facts | documented public API or reviewed official source | mapped venue/location | observation/forecast validity and local UTC retrieval required | NWS access guidance reviewed 2026-07-12; configured identifying User-Agent required | operational gate under a versioned rule only; not a probability input | conditional approved source class; venue/rule mapping required |
| sportsbook-originated target evidence | exact target quote, promotion, jurisdiction, tie, push, void, and settlement terms | 1 for displayed target | timestamped user screenshot/structured manual verification or permitted documented feed | exact displayed book and state only | local UTC capture required; provider time retained when present | user-supplied evidence is the credential-free fallback; feed use requires separate review | target identity and promotion evidence | screenshot/manual fallback; feed unverified |
| licensed/documented multi-book odds provider | exact target or comparison markets | 1-2 for quoted markets | documented API/feed | contract-defined books and jurisdictions | provider and local UTC timestamps retained | exact contract, market use, and pricing-origin relationships must be reviewed | exact quotes within reviewed permission | provider-specific validation required |
| sportsbook-originated comparison evidence | one non-target comparison book | 2 | timestamped screenshot/structured manual verification or permitted documented feed | exact displayed book and state only | local UTC capture required | user-supplied evidence is conditional; automation requires documented permission | one exact complete opposing pair | conditional fallback |
| established secondary reporting | possible registered material-change lead | 4 | public report | named event/team; not an odds-jurisdiction source | publication and retrieval times required | exact source permission unresolved for automation | may create `WATCH` pending authoritative confirmation in a future active run | never recommendation-grade alone |

The [NFL.com Terms](https://www.nfl.com/legal/terms/) restrict systematic retrieval absent express prior written consent. NFL.com and NFL Football Operations pages therefore remain manual/on-demand references in this adapter unless a separate license or permission expressly covers the intended use. Do not scrape them, depend on undocumented endpoints, or treat a public page as authorization for a poller.
