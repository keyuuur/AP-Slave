...
|---|---|---:|---|---|---|---|---|---|
| [WNBA injury report](https://www.wnba.com/wnba-injury-report) | official submission state and player availability | 1 | public official page or permitted licensed feed | league-wide operational facts | retain report version/publication time when available plus local UTC retrieval | WNBA Terms reviewed 2026-07-12; operational facts only, not NBA Statistics | operational eligibility and price-invalidation facts under permitted manual/on-demand access | conditional approved use; reverify terms |
| [WNBA schedule](https://www.wnba.com/schedule) | event identity, date, teams, and scheduled tip | 1 | public official page or permitted licensed feed | league-wide event facts | retain local UTC retrieval and provider event time | WNBA Terms reviewed 2026-07-12; operational facts only | operational event identity under permitted manual/on-demand access | conditional approved use; reverify terms |
| [WNBA roster tracker](https://www.wnba.com/players/roster-tracker) | team membership and roster state | 1 | public official page or permitted licensed feed | league-wide roster facts | retain local UTC retrieval | WNBA Terms reviewed 2026-07-12; operational facts only | operational identity/eligibility under permitted manual/on-demand access | conditional approved use; reverify terms |
| [WNBA transactions](https://www.wnba.com/players/transactions) | signings, waivers, trades, releases, and related changes | 1 | public official page or permitted licensed feed | league-wide transaction facts | retain transaction date plus local UTC retrieval | WNBA Terms reviewed 2026-07-12; operational facts only | operational identity/eligibility and price invalidation under permitted manual/on-demand access | conditional approved use; reverify terms |
| official WNBA team announcement | confirmed starting five or concrete role/availability change | 2 | permitted public announcement or licensed feed | named team/event only | publication and retrieval times required | team/platform terms must be reviewed for the exact source; unresolved sources cannot clear a gate | early confirmation and price invalidation | conditional; confirm identity and permission |
| licensed/documented sports-data provider | schedule, status, roster, or availability | 2 | documented API/feed | contract-defined | provider and local UTC timestamps retained | exact contract/use terms must be reviewed; no provider is approved generically | operational facts within the reviewed license | provider-specific validation required |
| sportsbook-originated target evidence | exact target quote and promotion terms | 1 for the target screen | timestamped user screenshot/manual verification or permitted documented feed | exact displayed book and state only | local UTC capture required; provider time retained if present | user-supplied screen/manual evidence is the pilot fallback; automated-feed permission remains unverified until documented | target quote and promotion identity | screenshot/manual default; feed unverified |
| licensed/documented multi-book odds provider | comparison markets | 1 for quoted markets | documented API/feed | contract-defined books and jurisdictions | provider and local UTC timestamps retained | exact contract/use terms and pricing-origin relationships must be reviewed | exact comparison quotes within the reviewed license | provider-specific validation required |
| sportsbook-originated comparison evidence | one comparison book | 2 | timestamped screenshot/manual verification or permitted documented feed | exact displayed book and state only | local UTC capture required | user-supplied screen/manual evidence is conditional; automated access requires documented permission | exact comparison pair | conditional fallback |
| established secondary reporting | possible material-change lead | 4 | public report | named event/team; not an odds jurisdiction source | publication and retrieval times required | exact source terms unverified for automated collection | may create `WATCH` pending stronger confirmation | never recommendation-grade alone |
...
- [DraftKings WNBA](https://sportsbook.draftkings.com/leagues/basketball/wnba) may count as at most one non-target comparison pricing origin when an exact current two-sided market can be verified.
